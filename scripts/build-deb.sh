...
chmod 0755 "$APP_DIR/scripts/preflight.sh" "$APP_DIR/scripts/install-direct-bridge.sh" "$APP_DIR/scripts/update-debian.sh" "$APP_DIR/scripts/verify-control-assets.py" "$APP_DIR/scripts/ge360-rilievi-status" "$APP_DIR/scripts/ge360-rilievi-diagnose"
