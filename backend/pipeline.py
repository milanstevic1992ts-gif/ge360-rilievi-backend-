...
class Pipeline:
    ...
    def process(self,pid):
        ...
        try:
            ...
            return {"success":True,"planId":pid,"status":status.value,"version":ver,"needsReview":model.needsReview,"quality":quality,"summary":summary,"aiAvailable":False,"aiMode":"copilot-only","geometry":{"walls":[w.model_dump(mode="json") for w in model.walls],"openings":[o.model_dump(mode="json") for o in model.openings],"rooms":[r.model_dump(mode="json") for r in model.rooms]}}
