...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        telegram_enabled=_bool("GE360_TELEGRAM_ENABLED", False),
        telegram_bot_token=os.getenv("GE360_TELEGRAM_BOT_TOKEN", ""),
        telegram_chat_id=os.getenv("GE360_TELEGRAM_CHAT_ID", ""),
        public_base_url=os.getenv("GE360_PUBLIC_BASE_URL", "").rstrip("/"),
    )
